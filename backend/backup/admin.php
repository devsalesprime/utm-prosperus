...
<body>
    ...
    <div class="container mt-5">
        <div class="row mb-4">
            <div class="col">
                <img src="images/logo-light.png" alt="Logo" class="img-fluid d-none" id="logo-light"
                    style="max-width: 150px;">
                <img src="images/logo-dark.png" alt="Logo" class="img-fluid d-block" id="logo-dark"
                    style="max-width: 150px;">
                <script>
                                ...
                                <td>
                                    <div class="btn-group" role="group">
                                        <?php if (!$user['is_approved']): ?>
                                            ...
                                            <form method="POST" class="d-inline me-1">
                                                <input type="hidden" name="user_id" value="<?= $user['id'] ?>">
                                                <button type="submit" name="reject" class="btn btn-danger btn-sm" title="Rejeitar"
            ...
            <div class="card-body">
                <form method="POST" class="row g-3">
                    ...
                    <div class="col-md-2 d-flex align-items-end">
                        <button type="submit" name="add_team_member" class="btn btn-primary w-100">
